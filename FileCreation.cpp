...
int FileCreation::fillNumbers(string filename, int Kilobytes){
    filename += ".csv";
    string filePath = "/home/itsrichard/Documentos/Proyectos C++/Tarea Extraclase 1/Paginated Array/TestFiles/" + filename;
...
int FileCreation::convertIntFile(string filename) {
    string pathIntFile = "/home/itsrichard/Documentos/Proyectos C++/Tarea Extraclase 1/Paginated Array/TestFiles/" + filename;
    filename.erase(filename.end()-4, filename.end());
    string newfile = filename + "Binary.bin";
    string pathBinaryFile = "/home/itsrichard/Documentos/Proyectos C++/Tarea Extraclase 1/Paginated Array/FilesBinary/" + newfile;
    cout << newfile << endl;
    string line, word;
...
int FileCreation::createFileCSV(string filename){
    filename += ".csv";
    string folderPath = "/home/itsrichard/Documentos/Proyectos C++/Tarea Extraclase 1/Paginated Array/TestFiles/" + filename;
    ofstream reader;
